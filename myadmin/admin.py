...
class MyUserAdmin(UserAdmin):
    fieldsets = (
        (None, {'fields': ('name','furigana', 'birthday', 'thumbnail', 'address', 'phone', 'password')}),
    ...
    list_display = ('email', 'name', 'thumbnail', 'address', 'furigana', 'phone', 'birthday', 'clinic_name', 'is_online', 'is_staff', 'is_active', 'is_superuser')
